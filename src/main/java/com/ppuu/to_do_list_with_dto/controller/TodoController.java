...
import com.ppuu.to_do_list_with_dto.dto.TodoDto;
import com.ppuu.to_do_list_with_dto.model.Todo;
import com.ppuu.to_do_list_with_dto.model.User;
import com.ppuu.to_do_list_with_dto.repository.TodoRepository;
...
public class TodoController {
    ...
    private User getCurrentUser(HttpSession session) {
        return (User) session.getAttribute("user"); // ?? 어케 가능
    }
